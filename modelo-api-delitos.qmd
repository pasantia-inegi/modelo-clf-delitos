...
$^*$ [Para editar nuestras variables de ambiente del archivo *.Renviron*, podemos hacerlo usando la función `usethis::edit_r_environ()`, la cual nos abrirá un archivo *.Renviron*. Una vez realizadas las modificaciones, reiniciamos la sesión de R para observar los cambios.]{.medium-par}
